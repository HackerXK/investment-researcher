...
> **LLM-generated intelligence fields**: `summary`, `risk_factors`, and `opportunities` are generated by LLM from 10-K filing text at ingestion time and refreshed whenever a new 10-K or 10-Q is processed. They are the primary source of qualitative context for the agent system — an agent reading a Company node gets an immediate picture of the investment case without needing to re-read the filing.
